...
public class CustomCsvWriter {
	...
	public void writeComment(String commentText) throws IOException {
		...
		if (useCustomRecordDelimiter) {
			...
			outputStream.write(systemRecordDelimiter.getBytes());
		}
	 ...
	 */
	/*
	 * private void checkInit() throws IOException { if (!initialized) { if
	 * (fileName != null) { outputStream = new BufferedWriter(new
	 * OutputStreamWriter( new FileOutputStream(fileName), charset)); }
	 * 
	 * initialized = true; } }
	 */
